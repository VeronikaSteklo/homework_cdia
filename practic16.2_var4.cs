...
class Program
{
    struct Student
    {
        ...
        public int Exam2;
        public int Exam3;
        public bool NotHasPassed()
        {
            return Exam1 == 2 || Exam2 == 2 || Exam3 == 2;
        }
    ...
    static void Main(string[] args)
    {
        ...
        string outputFilePath = "C:\\Users\\veron\\source\\repos\\task9\\output16_2.txt";
        try
        {
            ...
            var notPassedStudents = students.Where(s => s.NotHasPassed())
                                                .GroupBy(s => s.GroupNumber)
                                                .OrderBy(g => g.Key);

            using (StreamWriter writer = new StreamWriter(outputFilePath))
            {
                foreach (var group in notPassedStudents)
                {
