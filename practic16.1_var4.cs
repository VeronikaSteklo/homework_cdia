...
class Program
{
    static void Main(string[] args)
    {
        ...
        string outputFilePath = "C:\\Users\\veron\\source\\repos\\task9\\output16.txt";
        ...
        try
        {
            ...
            var filteredNumbers = numbers.Where(num => num < a || num > b)
                                         .OrderBy(num => num)
                                         .ToList();
            Console.WriteLine("Числа не лежащие на отрезке [{0}, {1}], отсортированные по возрастанию:", a, b);
