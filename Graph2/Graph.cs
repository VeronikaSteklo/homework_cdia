...
public class Graph
{
    ...
    public void Dijkstra(int v)
    {
        ...
        Console.WriteLine($"Кратчайшие пути до вершины {v}:");
        ...
        for (int i = 0; i < graph.Size; i++)
        {
            ...
            {
                Console.Write($"От вершины {i}: длина = {dist[i]}, путь: ");
                Stack<int> path = new();
    ...
    public void RemoveEdge(int a, int b)
    {
        ...
        {
            graph[a, b] = 0;
            graph[b, a] = 0; // если граф неориентированный
        }
        else
        {
            Console.WriteLine("Ошибка: неверные индексы вершин.");
        }
    }
}
